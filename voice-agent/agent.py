...
def speak(text):
    """
    Convert text into speech & print to console.
    Used for every assistant response.
    """
...
# -------------------------------------------------------------
print("Voice agent started. Talk when you're ready!")
...
"""
        ...
        if not result:
            ...
            if weather:
                ...
                if temp:
                    msg += f" The weather looks {desc}, around {temp}°C."

            if seating == "outdoor":
                msg += " Outdoor seating is recommended."
            else:
                msg += " Indoor seating is recommended."
